...
a persistence unit "codigoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "codigo\pom.xml":
...
artifacts ("codigo-ejb.jar" and "codigo-web.war") are already built. You can build
